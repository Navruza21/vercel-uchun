...
window.onload = () => {
  ...
  const positionConfirmModal = document.getElementById(
    "departmentConfirmModal"
  );
...
const renderDepartments = () => {
  ...
  api
    ...
    <tr>
      ...
      <button class="btn btn-danger" onclick="openDepartmentConfirmModal(${
        d.id
      })">
...
const renderPositions = () => {
  ...
  api
    ...
    <tr>
      ...
      <button class="btn btn-danger" onclick="openPositionConfirmModal(${
        d.id
      })">
      <i class="fas fa-trash" ></i>
      </button>
...
const saveDepartment = async () => {
  ...
  try {
    if (departmentId) {
      ...
      toastSuccess("department update successfully");
      departmentId = null;
    } else {
...
const savePosition = async () => {
  ...
  try {
    if (positionId) {
      ...
      toastSuccess("position update successfully");
      positionId = null;
    } else {
...
const removePosition = () => {
  api
    ...
    .then((res) => {
      toastSuccess("position has been deleted successfully");
